...
public class ModFoods {
    //    Components
    public static final FoodComponent WOOD_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent CAT_APPLE = new FoodComponent.Builder().nutrition(2).saturationModifier(0.6F).alwaysEdible().build();
    public static final FoodComponent BONES_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent COAL_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent COPPER_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent DIAMOND_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent IRON_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent EMERALD_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent LAPIS_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent LEATHER_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent NETHERITE_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent REDSTONE_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    ...
    public static final FoodComponent LEAVES_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent WOOL_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent WATER_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    ...
    public static final FoodComponent STARS_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    ...
    public static final FoodComponent SLIME_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    ...
    public static final FoodComponent LAVA_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent HONEY_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
    public static final FoodComponent ENDER_APPLE = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).alwaysEdible().build();
